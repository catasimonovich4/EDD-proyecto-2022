...
/**
 * Clase Comparador que implementa java.util.Comparator.
...
public class Comparador<E> implements java.util.Comparator<E> {
	 ...
	 * @return Retorna 0 si a es igual a b, un entero negativo si a
	 * es menor a b y un entero positivo si a es mayor a b.
	 */
